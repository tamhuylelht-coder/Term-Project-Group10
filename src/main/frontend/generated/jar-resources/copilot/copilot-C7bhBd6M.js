...
const mr = async (t, e, r) => window.Vaadin.copilot.comm(t, e, r), ot = "copilot-", pl = "25.1.4", ul = "undefined", Td = "attention-required", Dd = "https://plugins.jetbrains.com/plugin/23758-vaadin", zd = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode", Id = "https://marketplace.eclipse.org/content/vaadin-tools";
function Rd(t) {
  return t === void 0 ? !1 : t.nodeId >= 0;
}
function hl(t) {
  if (t.javaClass)
    return wl(t.javaClass);
}
function It(t) {
...
function Zd(t) {
  const e = yi(t), r = mi(e);
  !e.every((a) => Al(a, r)) && e.length > 0 && e[0].scrollIntoView();
}
function yi(t) {
  const e = t;
  if (!e)
...
window.Vaadin.copilot._machineState = new zl();
...
const V = (t) => new Ai(typeof t == "string" ? t : t + "", void 0, lo), Ll = (t, ...e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Ul, defineProperty: Zl, getOwnPropertyDescriptor: jl, getOwnPropertyNames: Wl, getOwnPropertySymbols: Fl, getPrototypeOf: Xl } = Object, wr = globalThis, Yo = wr.trustedTypes, Hl = Yo ? Yo.emptyScript : "", Jl = wr.reactiveElementPolyfillSupport, vt = (t, e) => t, ar = { toAttribute(t, e) {
  switch (e) {
    case Boolean:
      t = t ? Hl : null;
      break;
  ...
  return r;
} }, co = (t, e) => !Ul(t, e), Go = { attribute: !0, type: String, converter: ar, reflect: !1, useDefault: !1, hasChanged: co };
...
let He = class extends HTMLElement {
  ...
  static createProperty(e, r = Go) {
    if (r.state && (r.attribute = !1), this._$Ei(), this.prototype.hasOwnProperty(e) && ((r = Object.create(r)).wrapped = !0), this.elementProperties.set(e, r), !r.noAccessor) {
      ...
      a !== void 0 && Zl(this.prototype, e, a);
    }
  }
  static getPropertyDescriptor(e, r, o) {
    const { get: a, set: i } = jl(this.prototype, e) ?? { get() {
      return this[r];
    }, set(n) {
      this[r] = n;
    } };
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Kl = { attribute: !0, type: String, converter: ar, reflect: !1, hasChanged: co }, Ql = (t = Kl, e, r) => {
...
function at(t) {
  return (e, r) => typeof r == "object" ? Ql(t, e, r) : ((o, a, i) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const uo = globalThis, ir = uo.trustedTypes, $o = ir ? ir.createPolicy("lit-html", { createHTML: (t) => t }) : void 0, Pi = "$lit$", ue = `lit$${Math.random().toFixed(9).slice(2)}$`, Vi = "?" + ue, _l = `<${Vi}>`, Ie = document, wt = () => Ie.createComment(""), xt = (t) => t === null || typeof t != "object" && typeof t != "function", ho = Array.isArray, $l = (t) => ho(t) || typeof t?.[Symbol.iterator] == "function", Nr = `[ 	
\f\r]`, lt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ea = /-->/g, ta = />/g, xe = RegExp(`>|${Nr}(?:([^\\s"'>=/]+)(${Nr}*=${Nr}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ra = /'/g, oa = /"/g, Ci = /^(?:script|style|textarea|title)$/i, Ni = (t) => (e, ...r) => ({ _$litType$: t, strings: e, values: r }), ce = Ni(1), Hd = Ni(2), Re = Symbol.for("lit-noChange"), S = Symbol.for("lit-nothing"), aa = /* @__PURE__ */ new WeakMap(), Ee = Ie.createTreeWalker(Ie, 129);
function Ti(t, e) {
...
const ec = (t, e) => {
  ...
  for (let s = 0; s < r; s++) {
    ...
    i += n === lt ? l + _l : u >= 0 ? (o.push(c), l.slice(0, u) + Pi + l.slice(u) + ue + b) : l + ue + (u === -2 ? s : b);
  }
    ...
    for (; (a = Ee.nextNode()) !== null && l.length < s; ) {
      if (a.nodeType === 1) {
        if (a.hasAttributes()) for (const u of a.getAttributeNames()) if (u.endsWith(Pi)) {
          ...
          l.push({ type: 1, index: i, name: w[2], strings: b, ctor: w[1] === "." ? rc : w[1] === "?" ? oc : w[1] === "@" ? ac : xr }), a.removeAttribute(u);
...
class tc {
  ...
  u(e) {
    ...
    for (; l !== void 0; ) {
      if (n === l.index) {
        let c;
        l.type === 2 ? c = new it(i, i.nextSibling, this, e) : l.type === 1 ? c = new l.ctor(i, l.name, l.strings, this, e) : l.type === 6 && (c = new ic(i, this, e)), this._$AV.push(c), l = o[++s];
      }
...
class it {
  ...
  $(e) {
    ...
    if (this._$AH?._$AD === a) this._$AH.p(r);
      ...
      const i = new tc(a, this), n = i.u(this.options);
...
const Jd = { I: it }, nc = uo.litHtmlPolyfillSupport;
nc?.(St, it), (uo.litHtmlVersions ??= []).push("3.3.0");
const sc = (t, e, r) => {
...
let Di = !1;
function pc() {
  kt().publicPluginsState === "NOT_INITIALIZED" && (ae.push(import("./copilot-log-plugin-h3VQq9-2.js")), ae.push(import("./copilot-info-plugin-sfSeRBmW.js")), ae.push(import("./copilot-features-plugin-Bclmq7gl.js")), ae.push(import("./copilot-feedback-plugin-1zAxYjpE.js")), ae.push(import("./copilot-settings-panel-ZoFKAdB8.js")), ae.push(import("./copilot-impersonator-plugin-DcZdAFXt.js")), ae.push(import("./copilot-development-setup-user-guide-Bg1Jpy5v.js")), Di = !0, kt().setPublicPluginsState("IMPORTED"));
}
function Tr() {
...
const mc = typeof crypto < "u" && crypto.randomUUID && crypto.randomUUID.bind(crypto), sa = { randomUUID: mc };
function yc(t, e, r) {
  t = t || {};
  const o = t.random ?? t.rng?.() ?? bc();
  if (o.length < 16)
    throw new Error("Random bytes length must be >= 16");
  return o[6] = o[6] & 15 | 64, o[8] = o[8] & 63 | 128, fc(o);
}
function zi(t, e, r) {
  return sa.randomUUID && !t ? sa.randomUUID() : yc(t);
}
const Wt = [], ut = [], Gd = async (t, e, r) => {
  let o, a;
  e.reqId = zi();
...
const Mc = qc(Qr), _ = window.Vaadin.copilot._machineState;
if (!_)
...
const _d = (t, e) => t.error ? (Qc(t.error, e), !0) : !1, ca = (t, e, r) => {
  yr({
    type: Ze.ERROR,
    message: t,
    details: rr(
  ...
  a && i ? Yc(
    ...
    e,
    r
  ) : ca(t, e), Jc() && (o?.templateData && typeof o.templateData == "string" && o.templateData.startsWith("data") && (o.templateData = "<IMAGE_DATA>"), y.emit("system-info-with-callback", {
...
function tp() {
  Sr("use-dev-workflow-guide"), Oe.openPanel(od);
}
function Ui() {
  const t = kr.jdkInfo;
...
async function Mt() {
  return (await import("./copilot-focus-trap-D6_tO8dw.js")).copilotFocusTrap;
}
async function Zi() {
  return (await Promise.resolve().then(() => hc)).copilotOverlayManager;
}
function pd() {
  return import("./typescript-jmYPauaZ.js").then((t) => t.t);
}
const ji = {
  edit: {
    label: "Edit",
...
const Br = (t) => {
  if (_.isActivationShortcut() && _.getToolbarExpandMode() !== "never")
    if (t.key === "Shift" && !t.ctrlKey && !t.altKey && !t.metaKey)
      ...
      if (dt++, dt === 2)
        return f.activeMode === "play" ? f.lastNonPlayMode === void 0 ? f.setActiveMode("edit", !0) : f.setActiveMode(f.lastNonPlayMode, !0) : f.setActiveMode("play", !0), ud(), dt = 0, !0;
      setTimeout(() => {
        dt = 0;
      }, 500);
    } else
...
const wa = (t) => {
  ...
  if (!e)
    return;
  const r = hd(e), o = e.localName === "copilot-main", a = or(e, "copilot-outline-panel") !== null, i = or(e, "copilot-toolbar") !== null;
  ...
  if (ya(t))
    ...
    if (f.loginCheckActive && f.setLoginCheckActive(!1), gd(e)) {
      t.stopPropagation();
      return;
    }
    y.emit("escape-key-pressed", { event: t });
  } else fd(t) && f.activeMode === "edit" ? (y.emit("delete-selected", {}), s = !0) : (t.ctrlKey || t.metaKey) && t.key === "d" && f.activeMode === "edit" ? (y.emit("duplicate-selected", {}), s = !0) : (t.ctrlKey || t.metaKey) && t.key === "b" ? (y.emit("show-selected-in-ide", { attach: t.shiftKey }), s = !0) : (t.ctrlKey || t.metaKey) && t.key === "z" && vd() ? (y.emit("undoRedo", { undo: !t.shiftKey }), s = !0) : ya(t) || y.emit("keyboard-event", { event: t });
  n && t.stopPropagation(), s && t.preventDefault();
}, fd = (t) => (t.key === "Backspace" || t.key === "Delete") && !t.shiftKey && !t.ctrlKey && !t.altKey && !t.metaKey;
function gd(t) {
  const e = t;
  if (Xo(t))
    return !0;
...
const oe = dd(), Ut = "⇧", ip = {
  ...
  bd().then((t) => f.setUserInfo(t)).catch((t) => qe("Failed to load userInfo", t));
}, bd = async () => mr(`${ot}get-user-info`, {}, (t) => (delete t.data.reqId, t.data));
 ...
 */
const Rr = (t) => t ?? S;
var md = Object.defineProperty, yd = Object.getOwnPropertyDescriptor, be = (t, e, r, o) => {
...
var wd = Object.defineProperty, xd = Object.getOwnPropertyDescriptor, bo = (t, e, r, o) => {
  for (var a = o > 1 ? void 0 : o ? xd(e, r) : e, i = t.length - 1, n; i >= 0; i--)
    (n = t[i]) && (a = (o ? n(e, r, a) : n(a)) || a);
  return o && a && wd(e, r, a), a;
};
let nr = class extends dc {
  ...
  async init() {
    if (this.initialized)
      return;
    await window.Vaadin.copilot._machineState.initializer.promise, await import("./copilot-global-vars-later-DKkGjSH-.js"), await import("./copilot-init-step2-D0JX2IbT.js"), vc(), this.tabIndex = 0, window.addEventListener("keydown", Br), this.addEventListener("keydown", wa), y.onSend(this.handleSendEvent), this.removers.push(
      ...
      async (e, r) => {
        ...
        Oe.restorePanelsFromStorage(), (e !== "play" || Array.from(Oe.getOpenPanelTags()).some((o) => Fs(o))) && (Wi(), pc(), uc(), await sd()), this.ensureTopmostPopover();
      },
      { fireImmediately: !0 }
    ), this.reaction(
      () => _.getSelectedSize(),
    ...
    t.observe(this), this.removers.push(() => {
      t.disconnect();
    }), Bc(), this.detectAppTheme(), this.initialized = !0, id();
  }
  disconnectedCallback() {
...
function sp(t, e, r) {
  return Xi(t, r).map((o) => Ed(o, e)).filter((o) => o !== void 0);
}
export {
  _ as $,
  Td as A,
